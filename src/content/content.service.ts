                  ...
                  for (const provider of responses.message.catalog.providers) {
                     ...
                     for (const [index, item] of provider.items.entries()) {
                        ...
                        let obj = {
                           ...
                           bpp_id: responses.context.bpp_id ? responses.context.bpp_id : responses.context.bpp_id,
                           bpp_uri: responses.context.bpp_uri ? responses.context.bpp_uri : "",
                           item: item,
       ...
       analytics.map((item) => {
         if(!item.response.error) {
            let obj = {
               ...
               scholarship_id: item.response.message.order?.items[0]?.id ? item.response.message.order.items[0].id : "",
               scholarship_name: item.response.message.order?.items[0]?.descriptor?.name ? item.response.message.order.items[0].descriptor.name : "",
               ...
               agent_name: item.response.message.order.fulfillments[0].agent.person.name,
